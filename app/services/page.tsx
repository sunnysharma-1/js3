...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive EMS solutions including PCB Assembly (SMT/THT), Rapid Prototyping, Wire Harness, Box Build & Design Engineering. ISO certified facility with 25+ years experience.",
  keywords: [
